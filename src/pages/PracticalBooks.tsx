        ...
        <section className="bg-gray-50 py-12 md:py-16">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg text-center max-w-3xl mx-auto text-justice-text/80 mb-8">
              Hands-on manuals for city planners, activists, and everyday cyclists. These practical 
              resources provide actionable strategies and real-world solutions for cycling advocacy 
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-2xl font-baskerville font-semibold text-justice-text">Practical Guides</h2>
            </div>
        ...
        <section className="py-8 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
              ...
              <Link to="/academic-books" className="block p-4 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <h3 className="font-baskerville text-lg mb-1">Academic Works</h3>
                <p className="text-sm text-justice-text/70">Research-based books examining cycling policy, infrastructure development, and social equity.</p>
              </Link>
            </div>
          </div>
        </section>
