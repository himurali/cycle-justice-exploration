...
const Interviews = () => {
  ...
  // Filter interviews by selected continent
  const filteredInterviews = selectedContinent === "All Continents" 
    ? interviews 
    : interviews.filter(interview => interview.continent === selectedContinent);
  ...
  const handleShareClick = (event: React.MouseEvent, interview: Interview) => {
      ...
      <div className="pt-20">
        ...
        <div className="bg-gradient-to-b from-gray-800 to-gray-600 py-16 px-4 rounded-b-3xl mb-8">
          <div className="container mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-2 font-baskerville">Interviews</h1>
            <p className="text-lg text-gray-200 max-w-2xl mx-auto">
              Conversations with cycling advocates, urban planners, and community leaders
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {currentItems.map((interview) => (
              <Card 
                ...
                onClick={() => handleVideoClick(interview.videoUrl)}
              >
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Button 
                      ...
                      onClick={(e) => handleShareClick(e, interview)}
                    >
