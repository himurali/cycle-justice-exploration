...
import { getPolicyResearch } from "@/lib/research";
import ResearchCard from "@/components/ResearchCard";

const ResearchPolicy = () => {
  const papers = getPolicyResearch();

  return (
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      {/* Header with gradient */}
      <div className="w-full py-12 mb-8 text-center rounded-lg bg-gradient-to-r from-gray-900 to-gray-500">
        <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">Policy</h1>
        <p className="text-lg text-gray-200">
          Research on mobility policies, governance, and implementation
        </p>
      </div>
