...
import { getEssentialBooks, BookItem } from '@/lib/books';
import BookCard from '@/components/BookCard';

const EssentialBooks = () => {
  const [books] = useState<BookItem[]>(getEssentialBooks());
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            <div className="flex items-center mb-8">
              ...
              <h2 className="text-2xl font-baskerville font-semibold text-justice-text">Essential Reading</h2>
            </div>
