        ...
        <section className="py-12 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              ...
              <Link to="/practical-books" className="block p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <h3 className="font-baskerville text-xl mb-2">Practical Guides</h3>
                <p className="text-justice-text/70">Hands-on manuals for city planners, activists, and everyday cyclists.</p>
              </Link>
            </div>
          </div>
        </section>
